...
| パス | 最小値 | 最大値 | 平均値 | 変化量 | FunctionCost |
|------|--------|--------|--------|--------|--------------|
| node3->node1 | 25000 | 25000 | 25000 | 0 | 0 |
| node3->node2 | 50000 | 50000 | 50000 | 0 | 25000 |
| node4->node1 | 50000 | 50000 | 50000 | 0 | 25000 |
| node4->node2 | 25000 | 25000 | 25000 | 0 | 0 |

**分析:**
- **全パスでコストは一定値を維持（変化なし）**
- **node1経由のパス**: FunctionCost = 0（元のコストのみ）
- **node2経由のパス**: FunctionCost = 25000（固定値）
